...
/***/ function(module, exports, __webpack_require__) {
	...
	var _testalias = __webpack_require__(7);

	var _testalias2 = _interopRequireDefault(_testalias);

	var _testalias3 = __webpack_require__(7);

	var _testalias4 = _interopRequireDefault(_testalias3);
	...
	console.log(_testalias2.default); //插入的样式直接在html文件中插入style!
	/*
	//1基本
	...
	*/
	...
	console.log(_testalias4.default);
	...
	console.log(store.getState((0, _index3.ChangeMax)()));

	store.dispatch((0, _index3.ChangeMax)());
	store.dispatch((0, _index3.ChangeMao)());
...
/***/ function(module, exports, __webpack_require__) {
	...
	function manStore(action) {
	  return (0, _redux.createStore)(_index2.default, action); // 初始化创建
	}
...
/***/ function(module, exports) {
	...
	var zxx = exports.zxx = 'Yiyun_max';
	var mao = exports.mao = 'Yiyun_mao';

	var day = 0;

	var ChangeMax = exports.ChangeMax = function ChangeMax(content) {
	  return {
	    type: zxx,
	    num: day++, //num获取不到？？？
	    content: content
	...
	var ChangeMao = exports.ChangeMao = function ChangeMao(content) {
	  return {
	    type: mao,
	    num: day++,
	    content: content
